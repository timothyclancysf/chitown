...
= 2.3.3 =
* Added Bootstrap2 library to avoid conflict with IG Contact Form

= 2.3.2 =
* Fixed Post's Password protection privacy mode not works if using IG PageBuilder
* Fixed Elements display incorrectly on back-end when adding more elements
* Fixed Element dragging not works in full mode
* Fixed Element is saved when clicking Delete Element button on Classic Editor tab.
* Fixed Text shortcode doesn't render output of other shortcodes
* Fixed Custom Css button is still displayed after turning off PageBuilder tab
* Fixed Progress Bar display incorrrect on front-end page when chose Presentation= Stacked
* Improved Move Preview Frame out of Styling tab
* Improved Cleanup shortcode syntax from empty parameters
* Improved Only load assets in relevent screens
* Improved Change widget loading mechanism to adapt more kinds of plugin
