...
class IG_Carousel extends IG_Pb_Shortcode_Parent {
	...
	public function element_shortcode_full( $atts = null, $content = null ) {
		...
		$script        = "<script type='text/javascript'>$( document ).ready(function(){if( $( '#$carousel_id' ).length ){ $( '#$carousel_id' ).carousel( {interval: $interval,$pause} );}});</script>";
		...
		$carousel_navigator = '';
		$chevron_left = '<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" x="0px" y="0px" width="86.592px" height="173.184px" viewBox="0 0 86.592 173.184" enable-background="new 0 0 86.592 173.184" xml:space="preserve" class="chevron-svg chevron-svg-left">
                    <polygon points="0.9,11.3 76.2,86.6 0.9,162 0,173.2 86.6,86.6 0,0" class="chevron-svg-path">
                </svg>';
        $chevron_right = '<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" x="0px" y="0px" width="86.592px" height="173.184px" viewBox="0 0 86.592 173.184" enable-background="new 0 0 86.592 173.184" xml:space="preserve" class="chevron-svg chevron-svg-right">
            <polygon points="0.9,11.3 76.2,86.6 0.9,162 0,173.2 86.6,86.6 0,0" class="chevron-svg-path">
        </svg>';
		if ($show_arrows == 'yes')
			$carousel_navigator = "<a class='left carousel-control project-control' href='' data-slide='prev'>{$chevron_left}</a><a class='right carousel-control project-control' href='' data-slide='next'>{$chevron_right}</a>";
